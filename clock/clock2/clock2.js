...
function documentLoaded() {
  ...
  //document.getElementById("clock").addEventListener("keyup", botaoClicked, false);
...
function botaoClicked() {
  ...
  limite = parseInt(document.getElementById("clock").contenteditable);//connected this to clock to get rid of txtTempo
